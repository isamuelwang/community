package com.owwang.community.qa.service;
...
import com.owwang.community.qa.dao.ProblemDao;
...
public class ProblemService {
	 ...
	 * @auther Samuel
	 */
	public Page<Problem> newlist(Integer labelid,Integer page,Integer rows){
	 ...
	 * @auther Samuel
	 */
	public Page<Problem> hotlist(Integer labelid,Integer page,Integer rows){
		Pageable pageable = PageRequest.of(page-1,rows);
	 ...
	 * @auther Samuel
	 */
	public Page<Problem> waitlist(Integer labelid,Integer page,Integer rows){
		Pageable pageable = PageRequest.of(page-1,rows);
